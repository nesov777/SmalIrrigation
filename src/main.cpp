...
#define PUMP 30000         // время работы в миллисекундах (пример: 60*1000 = 60000 - одна минута)
// #define SLEEP1 10000
// #define SLEEP2 10000
// #define PUMP 15000
...
void loop() {
  Narcoleptic.delay(SLEEP2);          //При подаче питания помпа включается не сразу, а спустя время SLEEP2. На случай "мигания" питания, чтобы не было потопа
